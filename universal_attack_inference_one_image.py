...
if __name__ == "__main__":
    ...
    #     # RuntimeError: The size of tensor a (313) must match the size of tensor b (256) at non-singleton dimension 2
    #     # 将 img_a 和 pgd_attack.up 的 size 对齐
    #     img_a = img_a.repeat(attgan_args.n_attrs+1, 1, 1, 1)
